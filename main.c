...
int main() {
  ...
  printf("\n");
  printf("after removing at line 6th ind 114 line list");
  list_print(mylist);
  ...
  list_free(mylist);
  list_print(mylist);
  printf("after removing at line 125 ind list");
  ...
  list_print(mylist);
  printf("\n after removing at line 140 ind list \n");
